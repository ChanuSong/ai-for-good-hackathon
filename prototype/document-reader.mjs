...
const words = {
  ko: {
    ...
    analyze: "분석 결과 예시 보기",
    notice:
      "지금은 이사 안내문으로 분석 결과를 체험해요. 업로드한 사진을 실제로 분석하지는 않아요.",
    result: "문서 분석 · 예시",
    summary: "이 문서는 무엇인가요?",
    who: "누가 확인해야 하나요?",
    when: "언제까지 해야 하나요?",
    ...
    original: "원문 확인",
    photo: "내가 가져온 사진",
    photoNote: "아래 결과는 이 사진에서 추출한 내용이 아닌 샘플 안내예요.",
    help: "담당 창구",
  ...
  ja: {
    ...
    analyze: "分析結果の例を見る",
    notice:
      "現在は住所変更の案内文で結果を体験します。アップロードした写真の実際の分析は行いません。",
    result: "文書分析 · サンプル",
    summary: "どんな文書？",
    who: "誰が確認する？",
    when: "いつまでに？",
    ...
    original: "原文を確認",
    photo: "取り込んだ写真",
    photoNote: "以下は写真から抽出した内容ではなく、サンプルの案内です。",
    help: "問い合わせ先",
  ...
  en: {
    result: "Document analysis · Sample",
    ...
    photo: "Your photo",
    photoNote:
      "The result below is a sample, not text extracted from your photo.",
    help: "Contact",
    checklist: "Continue to the checklist",
    sampleDoc: "Sample notice",
